...
SRC_DIR=`pwd`
DFT_DIST_DIR=$SRC_DIR/libcurl-ios
...
function build_for_arch() {
  ARCH=$1
  HOST=$2
SYSROOT=$3 # ${XCODE_DEV}/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk
  PREFIX=$4
